...
begin
  ...
  // we also test for a bug where branch before a coprocessor instruction
  // doesn't squash this
  ...
  inst( "nop                " );
  inst( "bne r1, r2, [+2]   " );
  inst( "mul r1, r1, r1     " ); // this should not be executed
  inst( "mul r3, r2, r1     " );
  inst( "nop                " );
  inst( "nop                " );
  inst( "nop                " );
  ...
  inst( "nop                " );
  inst( "mtc0 r3, proc2mngr " ); init_sink( 32'h00000014 );
  inst( "mtc0 r1, proc2mngr " ); init_sink( 32'h00000005 );
