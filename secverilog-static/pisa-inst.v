...
(
  ...
  input  [`PISA_INST_NBITS-1:0]        {Data domain} inst,

  // Packed fields

  output [`PISA_INST_OPCODE_NBITS-1:0] {Ctrl domain} opcode,
  output [`PISA_INST_RS_NBITS-1:0]     {Ctrl domain} rs,
  output [`PISA_INST_RT_NBITS-1:0]     {Ctrl domain} rt,
  output [`PISA_INST_RD_NBITS-1:0]     {Ctrl domain} rd,
  output [`PISA_INST_SHAMT_NBITS-1:0]  {Ctrl domain} shamt,
  output [`PISA_INST_FUNC_NBITS-1:0]   {Ctrl domain} func,
  output [`PISA_INST_IMM_NBITS-1:0]    {Ctrl domain} imm,
  output [`PISA_INST_TARGET_NBITS-1:0] {Ctrl domain} target
);
