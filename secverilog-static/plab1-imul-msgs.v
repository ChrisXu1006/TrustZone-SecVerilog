...
(
  ...
  input [`PLAB1_IMUL_MULDIV_REQ_MSG_A_NBITS-1:0]    {Data domain} a,
  input [`PLAB1_IMUL_MULDIV_REQ_MSG_B_NBITS-1:0]    {Data domain} b,

  // Packed message

  output [`PLAB1_IMUL_MULDIV_REQ_MSG_NBITS-1:0]     {Data domain} msg
);
